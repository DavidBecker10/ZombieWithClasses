...
void RacoonCity::initialize(bool twoPlayers) {
    ...
    Entities::Characters::Player::setStage(1);
    if (twoPlayers)
    {
    ...
    int i = (rand() % 2) + 3;
    EL.insert(new Entities::Characters::Homer(Vector2F(970.f, 1260.f), player1, player2));
    while (i > 0) {
        EL.insert(new Entities::Characters::Homer(Vector2F(((rand() % 230 + 130) * 10.0f), 1450.f), player1, player2));
        EL.insert(new Entities::Characters::Ghoul(Vector2F(((rand() % 230 + 130) * 10.0f), 1450.f), player1, player2));
        i--;
    }
    EL.insert(new Entities::Characters::Ghoul(Vector2F(5800.f, 1450.f), player1, player2));
