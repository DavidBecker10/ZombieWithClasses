...
States::Subway::Subway(Managers::GraphicManager* gm, Managers::ScreenManager* sm, Entities::Characters::PlayerOne* p1):
    Stage{ gm,
          new Managers::TilesManager{
                  ...
                  {32.0f, 32.0f}, "../assets/Maps/mapStage2.json"
          }, sm,
          p1 }
{
}
...
void States::Subway::initialize(bool numPlayers)
{
    srand(time(NULL));
